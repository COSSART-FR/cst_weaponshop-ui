    ...
    if Config.Ammunation.Licence then
        ESX.TriggerServerCallback('esx_license:checkLicense', function(hasWeaponLicense)
            if hasWeaponLicense and data.restricted then
                restricted = false
                TriggerServerEvent('cst_weaponshop-ui:buy', data.item, data.price, data.count, restricted)
        ...
        TriggerServerEvent('cst_weaponshop-ui:buy', data.item, data.price, data.count, false)
    end
    cb('ok')
end)

RegisterNUICallback('buy_licence', function(data, cb)
    TriggerServerEvent('cst_weaponshop-ui:buyLicence', data.licencePrice)
    cb('ok')
end)
