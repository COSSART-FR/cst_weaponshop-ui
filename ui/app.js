...
$(function () {
    ...
    $(document).keyup(function (e) {
        if (e.keyCode == 27) {
            $.post('http://cst_weaponshop-ui/close', JSON.stringify({}));
        }
    });
    // AFFICHAGE DU MENU
...
function buy_weapon(weapon) {
    $.post('http://cst_weaponshop-ui/buy', JSON.stringify(weapon));
}
...
function buy_licence(licencePrice) {
    $.post('http://cst_weaponshop-ui/buy_licence', JSON.stringify({ licencePrice: licencePrice }));
}
